// 66A - Petya and Java (https://codeforces.com/contest/66/problem/A)
...
function lengthMeasure (number, bytes, name_1, name_2) {
    if (number === bytes) { return console.log(name_1) ;}

    for (let i = 0; i < number.length; i++) {
        if (Number(number[i]) < Number(bytes[i])) { return console.log(name_1) }
        else if (Number(number[i]) > Number(bytes[i])) { return console.log(name_2) }
    }
    return console.log(name_2);
}
...
function main() {
    ...
    if (number.length < 3) {
        ...
        return lengthMeasure(number, '127', 'byte', 'short');
    } else if (number.length < 5) {
        return console.log('short');
    } else if (number.length === 5) {
        return lengthMeasure(number, '32767', 'short', 'int');
    } else if (number.length < 10) {
        return console.log('int');
    } else if (number.length === 10) {
        return lengthMeasure(number, '2147483647', 'int', 'long');
    } else if (number.length < 19) {
        return console.log('long');
    } else if (number.length === 19) {
        return lengthMeasure(number, '9223372036854775807', 'long', 'BigInteger');
    } else {
        return console.log('BigInteger')
    }
}